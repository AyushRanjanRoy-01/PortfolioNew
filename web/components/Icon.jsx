// Inline SVG icons (no dependency). Stroke icons inherit currentColor.
const PATHS = {
  ...
  network: <><circle cx="5" cy="6" r="2" /><circle cx="19" cy="6" r="2" /><circle cx="12" cy="18" r="2" /><path d="M6.7 7.4 11 16m6.3-8.6L13 16" /></>,
  route: <><circle cx="6" cy="6" r="2" /><circle cx="18" cy="18" r="2" /><path d="M8 6h6a3 3 0 0 1 3 3v6M6 8v4a3 3 0 0 0 3 3h4" /></>,
